...
export class Resetter extends Paperless.Control
{
	...
	{
		for(let guid in this._fuzzynotes.puzzled.getEntities(true))
		{
			...
			control.drawable.point.y -= this._fuzzynotes.puzzled.point.y - this._fuzzynotes.attributes.padding.top;
